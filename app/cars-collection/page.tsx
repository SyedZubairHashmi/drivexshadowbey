    ...
    <div className="bg-white min-h-screen pb-10">
      ...
      <div className="bg-green-900 text-white">
        <div className="w-full h-[400px] pb-16 flex flex-col items-center justify-center relative overflow-hidden px-4 sm:px-6 md:px-8">
          <h2 className="mt-6 text-2xl sm:text-3xl font-extrabold tracking-tight text-center">
            Cars Collection
          </h2>
          <p className="mt-3 text-base sm:text-lg font-normal tracking-tight text-center max-w-xl">
