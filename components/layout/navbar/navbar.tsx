...
const Navbar = () => {
  ...
  const isAccessoryDetailPage = pathname.includes("/accessories/") && pathname.match(/\/accessories\/\d+$/);
  ...
  const isLightPage = isContactPage || isCarDetailPage || isAccessoryDetailPage;
