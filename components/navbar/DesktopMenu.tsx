...
const DesktopMenu: React.FC<DesktopMenuProps> = ({
  ...
  return (
    <ul className={`hidden md:flex space-x-6 font-medium text-[16px] ${textColor} font-raleway`}>
      {/* Cars Dropdown */}
      <li className="relative cursor-pointer hover:text-gray-400 font-raleway">
        <div className="flex items-center gap-1" onClick={() => setCarsOpen(!carsOpen)}>
          Cars
          <FaChevronDown
            size={12}
      ...
      <li className="relative cursor-pointer hover:text-gray-400 font-raleway">
        <div className="flex items-center gap-1" onClick={() => setProductsOpen(!productsOpen)}>
          Products
          <FaChevronDown
            size={12}
        ...
        {productsOpen && (
          <div
            className="absolute  top-full left-1/2 transform -translate-x-1/2 mt-2 bg-white text-black rounded-xl shadow-xl w-[1320px] h-[288px] overflow-y-auto p-6 pl-8 font-raleway z-50"
          >
            <div className="grid grid-cols-4 gap-6 divide-x">
              ...
              <div className="pr-8">
                ...
                <ul className="space-y-1">
                  <li className="hover:text-green-400 cursor-pointer whitespace-nowrap">Seat Covers</li>
                  <li className="hover:text-green-400 cursor-pointer whitespace-nowrap">Floor Mats</li>
                  <li className="hover:text-green-400 cursor-pointer whitespace-nowrap">Steering Wheel Covers</li>
                  <li className="hover:text-green-400 cursor-pointer whitespace-nowrap">Dashboard Covers</li>
                  <li className="hover:text-green-400 cursor-pointer whitespace-nowrap">Sun Shades</li>
                </ul>
              </div>
